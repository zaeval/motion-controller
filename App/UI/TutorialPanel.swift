...
extension TutorialStep {
    ...
    var instruction: String {
        ...
        case .securityMode: "풀려 있는 동안 카메라에 보이는 얼굴을 계속 확인합니다. 등록된 얼굴이 안 보이는데 등록되지 않은 얼굴이 5초 안에 다섯 번 잡히면 (빠르면 1.25초) 화면이 바로 까매지고 잠깁니다. 같이 있다가 주인이 자리를 뜨면 3초 뒤부터 세기 시작해요. 아래에서 켜고 끌 수 있고, 정한 뒤 확인을 누르면 다음으로 넘어갑니다."
    ...
    var tip: String? {
        ...
        case .securityMode: "모르는 얼굴로 잠길 때는 그 순간 사진도 두 장 남겨요. 주인이 화면 앞에 있으면 뒤에 누가 있어도 잠그지 않아요. 얼굴이 안 보이거나 너무 멀거나, 주인인지 애매하거나, 방이 어두우면 그냥 둡니다. Touch ID·암호로 푼 뒤 2분간은 얼굴로 다시 잠그지 않아요. 얼굴 확인이 계속 돌아서 제스처 인식이 조금 느려질 수 있어요. 메뉴바에서 언제든 켜고 끌 수 있어요."
