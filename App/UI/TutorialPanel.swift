...
extension TutorialStep {
    ...
    var instruction: String {
        ...
        case .playPause: "주먹을 쥐고, 카메라 쪽으로 두 번 빠르게 팡팡 내밀어 보세요."
    ...
    var tip: String? {
        ...
        case .playPause: "손을 앞으로 쭉 내밀 필요는 없어요. 주먹을 쥔 채 가볍게 두 번 튕기면 됩니다. 손을 펴면 취소되고, 주먹을 뒤로 빼서 그대로 두면 IDLE이 돼요."
        ...
        case .zoom: "새끼손가락은 꼭 접어 주세요 — 네 손가락이 다 펴지면 손바닥으로 읽혀서 데스크탑 전환 모드로 갑니다. 확대가 남으면 ⌥⌘8로 끄세요. 화면이 안 바뀌면 시스템 설정 > 손쉬운 사용 > 확대/축소에서 키보드 단축키를 켜 주세요."
